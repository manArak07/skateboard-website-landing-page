...
export default function Footer() {
    return (
        <footer className="h-64 w-full font-rubik flex justify-center sm:h-80">
            <div className="w-[95%] h-full  flex justify-around items-center sm:flex-col">
                <div>
                    <div>
                        <h1 className="text-5xl  font-bold md:text-3xl sm:text-center">Brands available</h1>
                    </div>
                    <div className="mt-5 md:mt-2">
                        <h5 className="text-3xl font-medium md:text-2xl  text-[#4c4747] sm:text-center">Famous brands</h5>
                    </div>
